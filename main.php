				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">Skill Based Job Role Suggestion Using Machine Learning</h1>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Skill Based Job Role Suggestion Tool</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Skill Based Job Role Suggestion Tool</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About Skill Based Job Role Suggestion Tool</h2>
							<p class="lead" style="font-size: 18px; font-style: italic; margin-top: 50px;">As scholars are going through their academics and chasing their interested courses, it is important for them to impose their credentials and identify their interests so that they will get to know in which career field their interests and credentials are going to put them. This will help them in enhancing their performance and motivating their interests so that they will be directed towards their targeted career and get settled in that. Also, recruiters while retaining campaigners after assessing them in all different aspects, these kinds of career recommender systems help them in deciding which job part the seeker should be kept grounded on his/ her performance and other evaluations. Skill-based job role suggestion systems play a crucial role in modern recruitment processes by leveraging machine learning algorithms to match candidates with suitable job roles based on their skills and qualifications. This paper provides a comprehensive review of existing literature on skill-based job role suggestion systems, focusing particularly on machine learning algorithms and decision tree-based approaches, as well as the K-Nearest Neighbors (KNN) algorithm.</p>
